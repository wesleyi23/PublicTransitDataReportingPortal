# Generated by Django 2.2.6 on 2020-02-19 17:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=100)),
                ('heading', models.CharField(default='Ending Balances, December 31', max_length=50)),
            ],
        ),
        migrations.CreateModel(
            name='organization',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comments', models.TextField(blank=True, null=True)),
                ('heading', models.CharField(blank=True, default='Ending Balances, December 31', max_length=50, null=True)),
                ('history_id', models.AutoField(primary_key=True, serialize=False)),
                ('history_date', models.DateTimeField()),
                ('history_change_reason', models.CharField(max_length=100, null=True)),
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
