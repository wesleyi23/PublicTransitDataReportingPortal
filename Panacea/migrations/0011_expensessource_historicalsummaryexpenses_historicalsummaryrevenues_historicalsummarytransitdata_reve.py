...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('Panacea', '0010_auto_20190919_0955'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mode', models.CharField(choices=[('Light Rail', 'Light Rail'), ('Streetcar', 'Streetcar'), ('Demand Response', 'Demand Response'), ('Fixed Route', 'Fixed Route'), ('Commuter Bus', 'Commuter Bus'), ('Route Deviated', 'Route Deviated'), ('Vanpool', 'Vanpool'), ('Trolley Bus', 'Trolley Bus'), ('Bus Rapid Transit', 'Bus Rapid Transit'), ('Commuter Rail', 'Commuter Rail'), ('Demand Response Taxi Services', 'Demand Response Taxi Services')], max_length=80)),
                ('rollup_mode', models.CharField(choices=[('Fixed Route', 'Fixed Route'), ('Route Deviated', 'Route Deviated'), ('Demand Response', 'Demand Response'), ('Vanpool', 'Vanpool'), ('Commuter Rail', 'Commuter Rail'), ('Light Rail', 'Light Rail')], max_length=80)),
                ('administration_of_mode', models.CharField(choices=[('Direct Operated', 'Direct Operated'), ('Purchased', 'Purchased')], max_length=80)),
                ('metric', models.CharField(choices=[('Revenue Vehicle Hours', 'Revenue Vehicle Hours'), ('Total Vehicle Hours', 'Total Vehicle Hours'), ('Revenue Vehicle Miles', 'Revenue Vehicle Miles'), ('Total Vehicle Miles', 'Total Vehicle Miles'), ('Passenger Trips', 'Passenger Trips'), ('Operating Expenses', 'Operating Expenses'), ('Diesel', 'Diesel'), ('Gasoline', 'Gasoline'), ('Compressed Natural Gas', 'Compressed Natural Gas'), ('Propane', 'Propane'), ('Electricity', 'Electricity'), ('Employees - FTEs', 'Employees - FTEs'), ('Farebox Revenues', 'Farebox Revenues')], max_length=120)),
